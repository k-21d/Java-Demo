package com.k21d.rabbitmq.springbootamqp.amqp.container;
...
public class ContainerSender {
    public static void main(String[] args) throws Exception {
        ConnectionFactory connectionFactory = new CachingConnectionFactory(new URI(ResourceUtil.getKey("rabbit.uri")));
